...
public enum BuildingType  {
    ...
    private BuildingType newBuilding;
    ...
    public void createBuilding(BuildingType buildingType){
        if(buildingType == WALLS) this.newBuilding = WALLS;
        if(buildingType == MILITARY_BASE) this.newBuilding = MILITARY_BASE;
        if(buildingType == COURTHOUSE) this.newBuilding = COURTHOUSE;
        if(buildingType == CASTLE) this.newBuilding = CASTLE;
    }
}
