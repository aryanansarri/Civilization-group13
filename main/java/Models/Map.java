        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < columns; j++) {
                if (tile[i][j].getOwner() == getCivilization())
                    for (Tile tiles : tile[i][j].getSurroundingTerrain()) {
                        tileVisitingKinds[tiles.getCoordination().getX()][tiles.getCoordination().getY()] = Visible;
                    }
            }
        }
    }
            ...
            for (int j = 0; j < columns; j++) {
                if (tile[i][j].getCivilianUnit() != null)
                    if (tile[i][j].getCivilianUnit().getCivilization() == getCivilization())
                        for (Tile tiles : tile[i][j].getCivilianUnit().getVisibleTerrain()) {
                            tileVisitingKinds[tiles.getCoordination().getX()][tiles.getCoordination().getY()] = Visible;
                        }
            }
        }
            ...
            for (int j = 0; j < columns; j++) {
                if (tile[i][j].getMilitaryUnit() != null)
                    if (getCivilization() == tile[i][j].getMilitaryUnit().getCivilization())
                        for (Tile tiles : tile[i][j].getMilitaryUnit().getVisibleTerrain()) {
                            tileVisitingKinds[tiles.getCoordination().getX()][tiles.getCoordination().getY()] = Visible;
                        }
            }
        }
