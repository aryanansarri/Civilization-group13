    ...
    private void randomRiver(int x,int y,Random random){
        ...
        if (hasRiver.size() < riverCount){
            for (int i = 0; i < 6; i++) {
                if(random.nextBoolean()){
                    if (y % 2 == 1) {
                        if (i == 0 && !tile[x][y - 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x, y - 1,random);
                        }
                        if (i == 1 && x - 1 >= 0 && !tile[x - 1][y].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x - 1, y,random);
                        }
                        if (i == 2 && y + 1 < getColumns() && !tile[x][y + 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x, y + 1,random);
                        }
                        if (i == 3 && x + 1 < getRows() && !tile[x + 1][y - 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver(x + 1, y - 1,random);
                        }
                        if (i == 4 && x + 1 < getRows() && !tile[x + 1][y].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x + 1, y,random);
                        }
                        if (i == 5 && x + 1 < getRows() && y + 1 < getColumns() && !tile[x + 1][y + 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver(x + 1, y + 1,random);
                        }
                    }
                    if(y%2 == 0){
                        if (i == 0 && x - 1 >= 0 && y - 1 >= 0 && !tile[x - 1][y - 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x - 1, y - 1,random);
                        }
                        if (i == 1 && x - 1 >= 0 && !tile[x - 1][y].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x - 1, y,random);
                        }
                        if (i == 2 && x - 1 >= 0 && y + 1 < getColumns() && !tile[x - 1][y + 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x - 1, y + 1,random);
                        }
                        if (i == 3 && y - 1 >= 0 && !tile[x][y - 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x, y - 1,random);
                        }
                        if (i == 4 && x + 1 < getRows() && !tile[x + 1][y].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver(x + 1, y,random);
                        }
                        if (i == 5 && y + 1 < getColumns() && !tile[x][y + 1].getTerrainFeature().equals(TerrainFeature.River)) {
                            randomRiver( x, y + 1,random);
                        }
                    }
                }
