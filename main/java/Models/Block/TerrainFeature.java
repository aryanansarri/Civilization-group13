...
public enum TerrainFeature {
    ...
    Ice(0, 0, 0, 0, 0, false,new ArrayList<Resource>(List.of())),
    ...
    Marsh(2, 0, -1, 0, 33/100, true,new ArrayList<Resource>(List.of(Sugar))),
    River(-1,1,0,0,0,false,new ArrayList<Resource>(List.of())),
    Oasis(1, 1, 3, 0, 33 / 100, true,new ArrayList<Resource>(List.of()));
