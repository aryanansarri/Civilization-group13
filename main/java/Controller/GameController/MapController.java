...
public class MapController {
    ...
    private void showImprovements(StringBuilder stringBuilder, Tile terrain) {
        ...
        if (improvementPair != null) {
            ...
            if (improvement != null && improvementPair.getSecond() == true) {
                if (improvement.getNeededTech() == null || GameDatabase.getCurrentCivilization()
    ...
    private void showResources(StringBuilder stringBuilder, Tile terrain) {
        ...
        ArrayList<Technology> technologies = GameDatabase.getCurrentCivilization().getCivilizationTechnology()
                .getPassedTechnology();
    ...
    public String showDetails(Matcher matcher) {
        ...
        int y = Integer.parseInt(matcher.group("y"));
        TerrainValidate(x, y);
        Tile terrain = GameDatabase.getOriginalMap().getTile(x, y);
        TileVisitingKind terrainState = GameDatabase.getCurrentCivilization().getTileVisitingKind(x, y);
