...
public class MapController {
    ...
    private String GetBackGroundColor(Tile terrain){
        if(terrain.getType == TerrainType.DESERT)
            return "\u001B[43m";
        else if(terrain.getType == TerrainType.OCEAN)
            return "\u001B[44m";
        else if(terrain.getType == TerrainType.PLAIN)
            return "\u001B[42m";
        else if(terrain.getType == TerrainType.TUNDRA)
            return "\u001B[46m";
        else if(terrain.getType == TerrainType.SNOW)
            return "\u001B[47m";
        else if(terrain.getType == TerrainType.MOUNTAIN)
            return "\u001B[48;5;130m";
        else if(terrain.getType == TerrainType.GRASSLAND)
            return "\u001B[48;5;156m";
        else if(terrain.getType == TerrainType.HILL)
            return "\u001B[48;5;214m";
